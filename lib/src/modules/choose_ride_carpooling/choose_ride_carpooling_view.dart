...
class ChooseRideCarpoolingView extends StatelessWidget {
  ...
  final ChooseRideCarpoolingController controller = Get.put(ChooseRideCarpoolingController());
        ...
        children: [
          FlutterMap(
            ...
            children: [
              ...
              PolylineLayer(
                polylines: [Polyline(points: [pickupLocation, dropoffLocation], strokeWidth: 4.0, color: Colors.blue)],
              ),
            ],
          ),
          Align(
